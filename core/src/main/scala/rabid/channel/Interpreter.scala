...
import connection.{Input, Message}
import fs2.Pull
import fs2.concurrent.{Signal, SignallingRef}
import scodec.bits.ByteVector

import ChannelA.{AKleisli, Effect}
...
object Interpreter
{
  ...
  def notifyConsumer(signal: SignallingRef[IO, Option[Either[String, String]]], data: Either[String, String])
  : AKleisli[Unit] =
